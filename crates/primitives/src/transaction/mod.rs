...
impl Transaction {
    ...
    pub const fn chain_id(&self) -> Option<u64> {
        match self {
            ...
            | Self::Sponsored(TxSponsored { chain_id, .. }) => Some(*chain_id),
            #[cfg(feature = "optimism")]
            Self::Deposit(_) => None,
        }
    }
    ...
    pub const fn kind(&self) -> TxKind {
        match self {
            ...
            | Self::Sponsored(TxSponsored { to, .. }) => *to,
    ...
    pub const fn tx_type(&self) -> TxType {
        match self {
            ...
            Self::Sponsored(sponsored) => sponsored.tx_type(),
        }
    }
    ...
    pub const fn value(&self) -> U256 {
        *match self {
            ...
            | Self::Sponsored(TxSponsored { value, .. }) => value,
            #[cfg(feature = "optimism")]
    ...
    pub const fn nonce(&self) -> u64 {
        match self {
            ...
            | Self::Sponsored(TxSponsored { nonce, .. }) => *nonce,
    ...
    pub const fn gas_limit(&self) -> u64 {
        match self {
            ...
            | Self::Sponsored(TxSponsored { gas_limit, .. }) => *gas_limit,
            #[cfg(feature = "optimism")]
    ...
    pub const fn max_fee_per_gas(&self) -> u128 {
        match self {
            ...
            | Self::Sponsored(TxSponsored { max_fee_per_gas, .. }) => *max_fee_per_gas,
    ...
    pub const fn max_priority_fee_per_gas(&self) -> Option<u128> {
        match self {
            ...
            | Self::Sponsored(TxSponsored { max_priority_fee_per_gas, .. }) => {
    ...
    pub const fn effective_gas_price(&self, base_fee: Option<u64>) -> u128 {
        match self {
            ...
            Self::Sponsored(dynamic_tx) => dynamic_tx.effective_gas_price(base_fee),
            #[cfg(feature = "optimism")]
            Self::Deposit(_) => 0,
        }
    }
    ...
    pub const fn input(&self) -> &Bytes {
        match self {
            ...
            | Self::Eip7702(TxEip7702 { input, .. })
            | Self::Sponsored(TxSponsored { input, .. }) => input,
            #[cfg(feature = "optimism")]
    ...
    pub fn encode_with_signature(
        ...
        match self {
            ...
            Self::Sponsored(sponsored_tx) => {
                sponsored_tx.encode_with_signature(signature, out, with_header)
            }
        }
    }
...
impl Encodable for Transaction {
    ...
    fn encode(&self, out: &mut dyn bytes::BufMut) {
        match self {
            ...
            Self::Sponsored(sponsored_tx) => {
                sponsored_tx.encode_for_signing(out);
            }
        }
    }
    ...
    fn length(&self) -> usize {
        match self {
            ...
            Self::Sponsored(sponsored_tx) => sponsored_tx.payload_len_for_signature(),
        }
    }
}
...
impl TransactionSigned {
    ...
    pub(crate) fn payload_len_inner(&self) -> usize {
        match &self.transaction {
            ...
            Transaction::Sponsored(sponsored_tx) => {
                sponsored_tx.payload_len_with_signature(&self.signature)
            }
        }
    }
    ...
    pub fn decode_enveloped_typed_transaction(data: &mut &[u8]) -> alloy_rlp::Result<Self> {
        ...
        let transaction = match tx_type {
            ...
            TxType::Sponsored => Transaction::Sponsored(TxSponsored::decode_inner(data)?),
        };
    ...
    pub fn length_without_header(&self) -> usize {
        ...
        match &self.transaction {
            ...
            Transaction::Sponsored(sponsored_tx) => {
                sponsored_tx.payload_len_with_signature_without_header(&self.signature)
            }
        }
    }
}
